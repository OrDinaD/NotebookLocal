...
По умолчанию включен стабильный режим без Docling (`RAG_USE_DOCLING=0`) для совместимости на Apple Silicon.
Если нужен Docling-конвейер, включите `RAG_USE_DOCLING=1` в `.env`.
